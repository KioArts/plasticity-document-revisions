...
- Images and meshes (.OBJ, .STL, .FBX, etc.) can be arrayed, with controls for twist, scale, alignment, and placement along the curve. However, instancing is not supported.
