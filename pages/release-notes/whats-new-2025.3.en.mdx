...
- **Instance Workflow**     
The new *Create Instance* command creates live instances of Solids, Sheets, Curves, and Groups referencing the original geometry. This approach avoids duplicating mesh data, keeps models lightweight, and ensures that any modification to the parent object propagates automatically to all its instances.
...
### Localization
- **New Languages**  
Plasticity now allows you to configure up to 9 preferred languages in the **Preferences** section.
