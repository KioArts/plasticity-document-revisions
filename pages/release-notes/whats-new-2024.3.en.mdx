...
For more information, click [here](/solid/xnurb).
...
For more information, click [here](/common/move) for Move, [here](/common/move) for Rotate and [here](/common/move) for Scale. XXX
