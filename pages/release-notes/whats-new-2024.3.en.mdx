...
- **Improved Functionality**  
  - The command now supports selecting one or more faces to act as a rough `RefitTrim` or `TrimConvert` tool. It can also be executed without any preselected geometry, enhancing flexibility in various workflows.  
...
- **Proportional and Mirrored Transformations**  
  - Users can now edit surface CVs proportionally and with mirrored transformations, bringing the editing workflow closer to Sub-D modeling techniques. Refer [here](/common/move)  
