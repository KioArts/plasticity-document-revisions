...
## 10. UI 
- **Recent Files** - Files and items from the Recent Files list can now be dragged and dropped into the viewport for quick import.
- **Focus Point Orbitting** - Displays a focus point indicator (dot) when orbiting the view.
- **Side Bar** - Panels on the right side now function as menus.
- **Side Bar** - A toggle button has been introduced to show or hide the sidebar.
...
- **Tooltips** - Added tooltip images to specific tools to showcase the functions of certain options within the tool.
...
- **Suggested Commands Menu** - The "..." menu in the command bar can now be accessed using the <kbd>Shift + F</kbd> keybinding.
