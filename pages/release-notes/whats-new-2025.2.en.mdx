...
Plasticity 25.2 introduces a wide array of enhancements and new features aimed at improving surface modeling, enhancing usability, and streamlining operations. Below is a detailed overview of the updates:  
...
- **Measure Continuity**    
Measure Continuity lets you select pairs of edges and evaluate their continuity (G0, G1, or G2) in real time while the command is active. This tool is also integrated into the **Align** tool to help streamline your workflow. 
...
### Extend Command
- **Extend Sheet**       
The command now has a dialog **Limit** option which will specify the sheet extension until it reaches the inside or outside of a target body.
...
| ----- | -------- | ------- |
| mm (Millimeter) | 1 mm = 0.1 cm | `5 + 2mm` (**Result:** 5.2 cm) |
...
- February 25, 2025 [Version 2025.2](/release-notes/whats-new-2025.1)