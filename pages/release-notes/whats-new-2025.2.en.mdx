...
- **Disambiguing Selections**   
A selection context menu is availbe to disambiguiate selections based on selection mode when objects are overllaped each other. This can be achieved by holding <kbd>Ctrl + Shift</kbd> and Left-clicking or Left-clicking and Mouse Wheel Scrool.

[Learn more](/plasticity-essentials/selecting-objects)

### Point Selection Mode
- **CV Hull Selection** 
Now it's possible to select a row of CVs by selecting the CV hull with <kbd>Alt</kbd>.
