...
2. **In Cinema 4D:**
    ...
    4. Erstellen Sie ein **Subdivision Surface**-Objekt und platzieren Sie es innerhalb des **Outbox**-Nulls. Setzen Sie Ihre Kontrollkäfig-Geometrie (ein Polygon-Objekt, ein Primitiv wie Würfel oder Kugel oder einen beliebigen Generator-Stack wie Symmetrie, Verbinden, Boole oder Array) als Kind unter dieses Subdivision Surface. Die Editor-Unterteilungsstufe des Subdivision Surface muss **mindestens 1** sein.
        - Der Kontrollkäfig wird automatisch aufgelöst. Primitive, Generatoren und sogar verschachtelte Generator-Stacks werden über das Cache-System von Cinema 4D ausgewertet, sodass Sie live-prozedurale Setups hochladen können, ohne sie zuvor editierbar machen zu müssen.
