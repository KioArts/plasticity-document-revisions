...
When in perspective view, right click on the perspective/orthographic button (1) and insert a value for the Field of View. By default, the value is set to **50** in perspective view. 
