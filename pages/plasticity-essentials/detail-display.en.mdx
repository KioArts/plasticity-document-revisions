...
With Selection: Point <kbd>Num. 1</kbd> mode activated: 

| Point Types | Point Sub-type |
| ----------- | -------------- |
| Vertex and Control-Vertex (CV) | No Information |

With Selection: Point <kbd>Num. 2</kbd> mode activated:
...
With Selection: Point <kbd>Num. 3</kbd> mode activated:

| Face Types | Face Sub-type |
| ----------- | -------------- |
| Face | Plane, Cone, Torus, Cylinder, Sphere, and Spline |

With Selection: Point <kbd>Num. 4</kbd> mode activated:
