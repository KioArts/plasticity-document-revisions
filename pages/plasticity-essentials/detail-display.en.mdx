...
<mark>For example</mark>, if face selection mode **(1)** is activated only and you select several faces and a simple conic fillet shape on a cube **(2)**, it will display the type of selection with a number of *3 Faces* **(3)**, along with the sub-type breakdown of *2 Planes* and *1 Cylinder* **(4)**.
...
Solid types: Solid, and Sheet.
Solid Sub-type: No Information.

| Point Types | Edge Types | Face Types | Solid Types | 
| :-----------: | :----------: | :----------: | :-----------: |
| Vertex and Control-Vertex (CV) | Edge (solid) and Curve (Sketch) | Face | Solid, and Sheet |

| Point Sub-types | Edge Sub-types | Face Sub-types | Solid Sub-types | 
| :-----------: | :----------: | :----------: | :-----------: |
| No Information | Line (Solid and Sketch) Circle (Solid and Sketch), Surface curve (Solid), Intersection (Solid) and Spline (Sketch) | Plane, Cone, Torus, Cylinder, Sphere, and Spline | No Information |
