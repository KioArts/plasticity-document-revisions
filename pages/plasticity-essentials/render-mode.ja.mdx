...
| 機能                                                        | ボタン | コマンド名                  |
| ----------------------------------------------------------- | ------ | --------------------------- |
| Toggle show Edges <br />(オフにするとエッジが非表示になります。) | (10)   | Viewport: toggle Edges    |
| Toggle show Curves <br />(オフにするとカーブが非表示になります。) | (11)   | Viewport: toggle Curves    |
| Toggle show Faces <br />(オフにすると面が非表示になります。)         | (12)   | Viewport: toggle Faces  |
