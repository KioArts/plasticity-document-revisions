...
2. Click on **Import/Append** from the top-left menu or press <kbd>Ctrl + Shift + O</kbd>.
![](/img/import.png)
3. A file selection dialog will be displayed.
   - Select an image file.
   - The system supports PNG and JPEG formats.
4. The image is imported and categorized as an "Image" in the Outliner.
![](/img/image.png)
...
![](/img/image-material.png)
   - **Depth**:
     ...
     - **Behind**: No matter where positioned, objects will always be displayed upfront. 
   - **Opacity**: 
