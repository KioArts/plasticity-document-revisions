...
| Ceramic Lightbulb  |   5    |  Highlight Checker     |  When [Render Mode](/plasticity-essentials/view-mode) is turned off, you can assign different material colors to be displayed in real time in the viewport. |
| Color Matcap |   6    |  Matte Appearance   | When [Render Mode](/plasticity-essentials/view-mode) is turned off, you can assign different material colors to be displayed in real time in the viewport. |
| Black Silhouette     |  7     |  Silhouettes Checker |  -   |
| Color Silhouette    |  8     |  Silhouettes Checker with Color | When [Render Mode](/plasticity-essentials/view-mode) is turned off, you can assign different material colors to be displayed in real time in the viewport. |
