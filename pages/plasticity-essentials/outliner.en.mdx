...
- Saved [construction planes](/plasticity-essentials/construction-plane) are classified into "Planes" and are listed in the "Added Planes" menu in the right side of the screen. 
...
- Assign an object a material by dragging the color dots and dropping on the 3D viewport on the object directly. 
