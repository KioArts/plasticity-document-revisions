...
- To temporarily disable snapping, press <kbd>Ctrl+X</kbd> key. This will allow you to temporarily disable different types of snaps if you repeat pressing it.  
