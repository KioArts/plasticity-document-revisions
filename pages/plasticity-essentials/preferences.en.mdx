...
- You can specify GPU rendering quality and CPU facet quality as well as enabling od disabling Ambient Occlusion in shader mode.
...
- Adjust the Ambient Occlusion appearance in the viewport by using the radius (1) and falloff (2) settings. (Default: 10 and 0.5)
