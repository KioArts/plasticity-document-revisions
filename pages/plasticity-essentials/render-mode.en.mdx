...
You'll notice that a ground-plane shadow appears beneath your objects. This shadow cannot be disabled at the moment, and it is positioned based on the lowest bounding box of the scene.

However, there's an important detail to note: objects placed above the world origin will not affect the position of the ground shadow **(2)**, meaning it will not follow them. In contrast, if objects are placed below the world origin, as shown in **(1)**, the shadow will respect the lower bounding box and adjust accordingly.

![Ground Shadow](/img/ground-shadow.png)
...
| ------------------------------------------------------------- |  ------ | ---------------------- |
| Toggle show Edges <br />(Turning this off will hide the Edges.) | (10)   | Viewport: toggle Edges |
| Toggle show Curves <br />(Turning this off will hide the Curves.) | (11)   | Viewport: toggle Curves |
| Toggle show Faces <br />(Turning this off will hide the Faces.) |  (12)   | Viewport: toggle Faces |
