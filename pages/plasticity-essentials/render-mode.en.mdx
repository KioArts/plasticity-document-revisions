...
![Options](/img/options-rotation-intensity.png)
...
| Intensity  |    (9)    |  Control the exposure of selected HDRI by dragging from left to right or inserting a numeric value. Min. value is 0 while max value is 10. (Default: 1.0)   |
