...
- **Auto Mark Edges** — Markiert ausgewählte Kanten als „sharp“ oder als UV‑Seams, abhängig von der letzten Operator‑Einstellung.
- **Merge UV Seams** — Verschmilzt doppelte Vertices entlang der Nähte der ausgewählten Flächen und stellt ein geschlossenes Mesh wieder her.
- **Select Plasticity Face(s)** — Erweitert die Auswahl auf alle Blender‑Flächen, die vom gleichen Plasticity‑Face stammen.
- **Select Plasticity Edges** — Wechselt nach einer Flächenauswahl zu den Blender‑Kanten, die den ursprünglichen Plasticity‑Kanten entsprechen.
- **Paint Plasticity Faces** — Backt eine eindeutige Vertex‑Farbe pro Plasticity‑Face. Nützlich für Substance Painter‑Masken oder prozedurale Shader, die Face‑IDs verwenden.
