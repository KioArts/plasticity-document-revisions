...
The bridge is built for the loop you actually work in, where geometry changes upstream and your downstream setup stays exactly where you left it. Materials and collections carry across automatically and a small panel of Blender commands handles everything else.
