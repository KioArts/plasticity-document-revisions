...
<details>
  ...
  <div className="px-4">
    <p className="mt-2">
      The <strong>Toggle Curvature</strong> tool analyzes the curvature of curves or surfaces to help you evaluate smoothness and continuity.
    ...
    <p className="mt-2">
      **Curvature** is calculated as the inverse of the radius at any given point on the curve. This value is represented graphically at discrete intervals using curvature "combs". The way these combs change along the curve - also known as the **flow** - gives insight into the curve's shape and behavior.
      ...
      1. The **length** of each curvature line is proportional to the inverse of the radius of the curve at that point. In other words, greater curvature corresponds to a smaller radius, which results in a longer curvature line. 
      2. The **direction** of each curvature line is perpendicular (normal) to the curvature at each point.  
      3. The **red** outline, in this example, represents the shape and flow of the curve. 
