...
Project the outline of the Solids or Sheets onto the current construction plane along the normal direction, thereby generating a curve. While the **Project Outline** command produces a projected curves in 2D, this command creates a 3D curve. Curves will be positioned precisely at the object's original boundary.
