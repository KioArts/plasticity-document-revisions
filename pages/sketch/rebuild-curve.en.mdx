  ...
  - <Kst>Command Dialog</Kst>
    - **Method:**
      ...
      - **Explicit Control:** Rebuild within the specified number of degree and spans. *(Available on Indie and Studio License)*
        ...
        - **Weight:** Depending on the *Degree and Spans*, you can adjust the **Weight** to control the position of CVs. A lower value loosens the curve's shape, improving quality for surface workflows. A higher value keeps the curve closer to its original shape, preserving accuracy and structure. (Default: 0.5)
