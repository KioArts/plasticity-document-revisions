...
**Selecting Edges Between Perfectly Connected Sheets**   
To choose the target edge, hover your cursor over the correct sheet near its edge and left-click. Then, to select the reference edge, make sure your cursor is over the other sheet and press <kbd>Shift</kbd> + Left-click on the edge. You'll see highlight indicators to help you identify which edge you're selecting.
</Callout>
...
Align more than two adjacent surfaces at once to enable broader blending across multiple areas. This is still an experimental feature and is currently being improved. The results and surface quality may vary depending on the complexity of the blended shape and its surrounding geometry.
