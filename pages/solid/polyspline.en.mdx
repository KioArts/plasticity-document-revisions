...
- **CVs** of PolySpline bodies can now be moved in Point Selection Mode. It is similar to moving the vertex points of a mesh body, but now possible on PolySpline geometry within Plasticity.
</Callout>
