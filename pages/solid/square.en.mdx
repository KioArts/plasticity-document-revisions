...
Square is an XNurbs based command that can create high-quality quad sided surfaces with the parametric feature of explicit control for UV degrees and spans.
