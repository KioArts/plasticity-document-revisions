...
3. Set the options in the Command Dialog.
   ...
   - **Continuity:** **Free, G0, G1, G2**
      - **Free:** Option that doesn't respect the boundary continuity, trading precicion continuity and resulting a better surface quality.
...
**Lofting with Square**
Alternatively, Square command can be used as a lofting approach with two floating edges. 
