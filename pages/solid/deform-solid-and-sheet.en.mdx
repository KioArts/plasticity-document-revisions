...
> **Note:** This works on open surfaces that are not periodic or closed. If the surface is periodic or closed, refer to the following chapter - [Using Deform on Closed Surfaces](/solid/deform-solid-and-sheet#surface-deformation-on-closed-surfaces).
