...
2. Select Face or Faces with <kbd>Shift</kbd> button to draft.
3. Click the button <ButtonIcon type="button-draft-face" /> in the [Suggested Commands](/plasticity-essentials/command-bar#suggested-commands) menu.
