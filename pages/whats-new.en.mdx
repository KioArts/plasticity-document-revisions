...
- **Weight Option**  
The Rebuild command now includes a new option **"Weight"** when using explicit control to rebuild a curve. Refer [here](/sketch/rebuild-curve).
...
For more information, click [here](/plasticity-essentials/snap).
...
- **Focus Point Orbiting** - Displays a focus point indicator (dot) when orbiting in the viewport.
- **Progress Indicator** - Opening large files will now show a simple progress indicator.
- **Tooltips** - Added tooltip images to various command options to showcase their functions. This serves as the groundwork for future improvements and more tooltips implementation. Below is a list of tools and their respective options that now feature tooltips:

| Tool | Options with Tooltips | 
| ---- | ------ |
| Bridge Surface | Tension and Trim Walls|
| Export OBJ | Max Width, Angle Tolerance and Inflect |
| Extend Sheet | Shape |
| Extend Curve | Shape |
| Fillet | Shape and Y-Blend |
| Imprint Curve | Method, Bidirectional, Hide Occluded and Complete |
| Project Curve | Method, Bidirectional and Hide Occluded |
| Offset | Grow |
| Sweep | Twist, Scale and Alignment |
| Square | Boundary |
| XNurbs | Quad-sided and Boundary |
