...
It was removed due to its unsafe implementation and replaced with the delete command <kbd>X</kbd> for edges. This strategy should allow for the joining of more fractured edges.
