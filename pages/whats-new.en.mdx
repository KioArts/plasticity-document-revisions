...
- **"Tension" Feature**  
Introducing a new feature enabling users to adjust the tension of the tangency along surface edges, similar to tools used in Lofting and Bridging workflows. It provides better control over shaping surfaces.
- **Improved Functionality**  
The command allows you to selectively refit trimmed surfaces on a face and its adjacent surfaces, aligning the orientation of splines to match the natural flow of the surface. It can also be executed without any preselected geometry. 
